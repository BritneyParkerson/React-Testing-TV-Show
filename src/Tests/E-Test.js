...
const episodes = [
    ...
    },
    {
      ...
      },
      {
        ...
        _links: {
            self: {
                href: "href":"http://api.tvmaze.com/episodes/909342"
            }
        }
    },
    {
...
test("renders episodes of Stranger Things"), () => {
    const { getAllByTestId, rerender } = render (<Episodes episodes={[]} />);
    expect(getAllByTestId("episode")).toHaveLength
    expect(getAllByTestId("episode")).toStrictEqual([]);
